...
length in boolean context without get magic doesn't need to handle
utf8-ness, it only needs to check the SvCUR field.  Analog to L<[cperl
#245]|https://github.com/perl11/cperl/issues/245> for ref.
