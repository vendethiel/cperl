...
%Modules = (
    ...
    'Cpanel::JSON::XS' => {
        'DISTRIBUTION' => 'RURBAN/Cpanel-JSON-XS-3.0230.tar.gz',
...
>>>>>>> ExtUtils-MakeMaker: Update to plain 7.24
    ...
    'IO::Compress::Base' => {
        'DISTRIBUTION' => 'PMQS/IO-Compress-2.070.tar.gz',
    ...
    'Math::BigInt' => {
        'DISTRIBUTION' => 'PJACKLAM/Math-BigInt-1.999809.tar.gz',
        ...
        # cperl c3, stricter tests and . in @INC fixes
        'CUSTOMIZED'   => [
            qw[
    ...
    'Storable' => {
        'DISTRIBUTION' => 'RURBAN/Storable-3.05_10.tar.gz',
